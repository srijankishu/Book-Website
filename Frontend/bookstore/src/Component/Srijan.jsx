...
const Srijan = () => {
  ...
  const getPdf = async () => {
    try {
      const result = await axios.get("https://book-website-gamma.vercel.app/get-files");
  ...
  const submitImage = async (e) => {
    ...
    try {
      await axios.post("https://book-website-gamma.vercel.app/book", formData, {
        headers: {
  ...
  const DeleteUser = async (id) => {
    ...
    try {
      await axios.post("https://book-website-gamma.vercel.app/deleteBook", { id });
